...
\begin{equation}
    \mathbf{f}_j = \rho_j \left(\mathbf{E} + \mathbf{u}_j \times \mathbf{B} \right),
...
\begin{equation}
    \frac{\partial n_j \mathcal{E}_j}{\partial t} = m_j \frac{d n_j\mathbf{u}_j}{dt} \cdot \mathbf{u}_j = \pm en_j \mathbf{u}_j \cdot \mathbf{E},
\end{equation}
